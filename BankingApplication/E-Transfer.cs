...
namespace BankingApplication
{
    public partial class E_Transfer : Form
    {
        ...
        public E_Transfer(UserInformation client, BankApplicationEntities dbContext)
        {
            this.client = client;
           ...
           if (txtCellNumber.Text.Length == 10)
            {
                ...
                MessageBox.Show("R" + txtAmount.Text + " Was sent to " + 
                    txtCellNumber.Text + " Code = " + txtCode.Text);
            }
            else
            {
            ...
            dbContext.E_Wallets.Add(wallet);
